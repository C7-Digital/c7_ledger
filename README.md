...
- Corresponds to Canton SDK version `3.3.0-snapshot.20250507.0`
...
The package uses the OpenAPI specification from Canton 3.3.0-SNAPSHOT. The spec is saved as a version specific file (e.x. `openapi_3.3.0-snapshot.2025050507.0.yaml`) and types are automatically generated into `src/generated/api.ts`.
